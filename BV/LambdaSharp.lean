...
-/)]
theorem Delta_convolution_eq : 1 = 1 := by sorry
...
-/)]
theorem Delta_one_bound : 1 = 1 := by sorry
...
theorem Delta_abel_summation : 1 = 1 := by sorry
...
theorem Delta_monotone_bound : 1 = 1 := by sorry
...
theorem Delta_flog_bound : 1 = 1 := by sorry
...
theorem Delta_LambdaSharp_bound : 1 = 1 := by sorry
...
theorem BV_LambdaSharp : 1 = 1 := by sorry